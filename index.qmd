---
title: "OJS HotReload in Quarto (experimental)"
subtitle: "Convert Quarto .qmd to .observable.html and preview with observable notebook-kit"
---
...
```{ojs}
md`test de markdown généré en ojs, la valeur calculée est ${y}`
```
